        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    logger.debug(f"除理失败 {e}")
                    continue

            if cursor and cursor.get("is_end"):
                logger.info("回复的通知已完全处理.")
                break
