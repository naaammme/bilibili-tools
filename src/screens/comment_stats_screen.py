...
class CommentStatsScreen(QWidget):
    ...
    def create_basic_stats_card(self):
        ...
        # 数据项
        items = [
            ("评论总数", self.stats_data.get('total_comments', 0), "#FFFFFF"),
            ("弹幕总数", self.stats_data.get('total_danmus', 0), "#FFFFFF"),
            ("通知总数", self.stats_data.get('total_notifies', 0), "#FFFFFF"),
        ]
    ...
    def create_source_stats_card(self):
        ...
        items = [
            ("B站评论", bilibili_comments, "#FFFFFF"),
            ("AICU评论", aicu_comments, "#ff6b9d"),
            ("B站弹幕", bilibili_danmus, "#FFFFFF"),
    ...
    def create_like_ranking_card(self):
        ...
        self.ranking_table.setColumnWidth(1, 120)  # 点赞数
    ...
    def create_message_stats_cards(self, layout):
        ...
        stats_items = [
            ("总私信数", str(message_stats.get('total_messages', 0)), "#FFFFFF"),
            ("总会话数", str(message_stats.get('total_conversations', 0)), "#FFFFFF"),
            ("未读消息", str(message_stats.get('unread_messages', 0)), "#FFFFFF"),
            ("今日消息", str(message_stats.get('today_messages', 0)), "#FFFFFF"),
        ]
